        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Edit Slider
                        <a href="{{ url('admin/sliders') }}" class="btn btn-sm btn-danger text-white float-end">Back</a>
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/sliders/'.$sliders->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="checkbox" name="status" value="{{asset($sliders->status == '1' ? 'checked' :'')}}" style="width: 30px;height:30px;">
